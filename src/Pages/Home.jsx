...
const Home = () => {
  return (
    <>
      ...
      >
        <h2 className="text-4xl font-bold mb-4">See my gillimpes</h2>

        <motion.div className="flex flex-row gap-4" initial={{ opacity: 0, x: 100 }} animate={{ opacity: 1, x: 0 }} transition={{ duration: 0.5 }}>
          <Pcard src="assets/img_1.jpeg" title="Project 1" description="Description of Project 1" />
          <Pcard src="assets/img_2.jpeg" title="Project 2" description="Description of Project 2" />
        ...
        <motion.div className="flex flex-row gap-4" initial={{ opacity: 0, x: 100 }} animate={{ opacity: 1, x: 0 }} transition={{ duration: 0.5 }}>
          ...
          <Pcard src="assets/img_4.jpeg" title="Project 4" description="Description of Project 4" />
          <Pcard src="assets/img_3.jpeg" title="Project 6" description="Description of Project 6" className="hidden md:flex" />
        </motion.div>

      </motion.div>

      <motion.div id="about" className="flex flex-col justify-center items-center font-sans py-20 text-[#1C352D] gap-8 shadow-md" initial={{ opacity: 0, y: 50 }} animate={{ opacity: 1, y: 0}} transition={{ duration: 0.5 }}> 
      ...
      <motion.div id="contact" className="flex flex-col justify-center items-center font-sans py-20 text-[#1C352D] gap-8 shadow-md" initial={{ opacity: 0, y: 50 }} animate={{ opacity: 1, y: 0}} transition={{ duration: 0.5 }}> 
